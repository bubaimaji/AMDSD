...
folder_path = '/home/suhita/Documents/multimodal/bangla/bn-audio/'  # Update this path
...
np.save("/home/suhita/Documents/multimodal/bangla/df.npy", df.to_dict('list'))


# To load the NPY files later
#train_data = np.load("/home/suhita/Documents/multimodal/bangla/df.npy", allow_pickle=True).item()
